                ...
                <Carousel.Item>
                    <div className=" d-block d-md-flex justify-content-between" style={{width:""}}>
                        ...
                        <div className="container-fluid  p-3 bg-light  rounded-5  " style={{width:"", height:"", color:"",marginLeft:""}}>
                            ...
                            <p className=" mt-1 fs-6 ">Ми вважаємо що особлива увага має приділятися саме дитячому навчанню. 
                            Адже діти дуже швидко засвоюють нову інформацію та нові знання. На цьому етапі найголовнішою задачею є збудувати міцний 
                            фундамент для подальшого вивчення мови. Дитяче навчання є найефективніше у групах. Завдяки груповому навчанню дитина не 
                            звикає ТІЛЬКИ до репетитора, а вчиться не боятися спілкуватись з іншими людьми. Це дозволяє попередити розвиток бар'єрів 
                            у спілкуванні та покращити комунікативні навички дитини. <br/>
