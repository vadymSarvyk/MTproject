...
export function KidsProg(){
    ...
    return(
        <div className="row  align-items-center p-5 bg-opacity-75 " style={{ color:"#2a1301",backgroundColor:"",backgroundImage:"url(./images/BG_grey3.png)", backgroundRepeat:"repeat", backgroundSize:"35%",}}>
            <Carousel className="w-75 mx-auto bg-light mt-5 rounded-5 mb-5" variant="dark" activeIndex={index} onSelect={handleSelect} style={{border:"double 0px black",boxShadow: "5px 6px 10px 0px rgba(117,115,117,1)"}}>
                <Carousel.Item>
                    <div className="d-block d-md-flex justify-content-between" style={{width:""}}>
                        ...
                        <div className=" w-50 mx-auto" style={{width:"", height:"", color:"",}}>
                            <img src={process.env.PUBLIC_URL+"./images/kidsProg1.jpg"} className="img-fluid rounded-5" alt="..."/>
                        </div>

                        <div className="w-50 p-3 bg-light  rounded-5 " style={{width:"", height:"", color:"",marginLeft:"10px"}}>
                            ...
                            <Button href="/form" className="btn btn-dark mt-5 p-2 rounded-3 fw-bold me-auto" style={{border:"double 0px white",width:"150px", backgroundColor:"#2a1301"} }>Приєднатися</Button>
                        </div>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className="d-block d-md-flex justify-content-center " style={{width:""}}>
                        ...
                        <div className="w-50 p-3" style={{width:"", height:"", color:"",marginLeft:"10px"}}>
                            <h4>Для школярів</h4>
                            <p className="card-text mt-1 fs-6">Ліс ще дрімає в передранішній тиші… Непорушне стоять дерева, загорнені в сутінь, рясно вкриті краплистою росою. Тихо навкруги, мертво… Лиш де-не-де прокинеться пташка, непевним голосом обізветься зі свого затишку. Ліс ще дрімає…   </p>
                            <Button href="/form" className="btn btn-dark mt-5 p-2 rounded-3 fw-bold me-auto" style={{border:"double 0px white",width:"150px", backgroundColor:"#2a1301"} }>Приєднатися</Button>
                        </div>
...
export function AdultsProg(){
    ...
    const handleSelect = (selectedIndex, e) => {
        setIndex(selectedIndex)};
    return(
        <div className="row  align-items-center p-5  bg-opacity-75 " style={{ color:"#2a1301",backgroundImage:"url(./images/BG_grey3.png)", backgroundRepeat:"repeat", backgroundSize:"35%",}}>
            <Carousel className="w-75 mx-auto bg-light mt-5 rounded-5 mb-5" variant="dark" activeIndex={index} onSelect={handleSelect} style={{border:"double 0px black",boxShadow: "5px 6px 10px 0px rgba(117,115,117,1)"}}>
                <Carousel.Item>
                    <div className="d-block d-md-flex justify-content-between " style={{width:""}}>
                        ...
                        <div className="w-50 p-3 bg-light bg-opacity-75 rounded" style={{width:"", height:"", color:"",marginLeft:"10px"}}>
...
export function BusinessProg(){
    ...
    const handleSelect = (selectedIndex, e) => {
        setIndex(selectedIndex)};
    return(
        <div className="row  align-items-center p-5 bg-light bg-opacity-75 " style={{ color:"#2a1301",backgroundColor:"",backgroundImage:"url(./images/BG_grey3.png)", backgroundRepeat:"repeat", backgroundSize:"35%",}}>
