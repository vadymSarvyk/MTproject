                ...
                <Carousel.Item>
                    <div className=" d-block d-md-flex justify-content-between" style={{width:""}}>
                        ...
                        <div className="container-fluid  p-3   " style={{width:"", height:"", color:"",marginLeft:"10px"}}>
                            ...
                            <p className=" mt-1 fs-6 ">Ми вважаємо, що особлива увага має приділятися саме дитячому навчанню. Адже діти дуже швидко засвоюють нову інформацію та нові знання. На цьому етапі найголовнішою задачею є побудова міцного фундаменту для подальшого вивчення мови. Найефективнішою формою дитячого навчанням є групове. Завдяки груповому навчанню дитина не звикає ТІЛЬКИ до репетитора, а вчиться не боятися спілкуватись з іншими людьми.
                                Це дозволяє попередити розвиток бар'єрів у спілкуванні та покращити комунікативні навички дитини.
                                {/*Навчимо дитину працювати у команді, не втрачаючи особисту мотивацію.*/}
                                <br/><br/>
                           ...
                           * Тривалість занять - по 60 хв.<br/>
                             * Тривалість курсу - 10 місяців.<br/>
                               * Вартість уроку - 150 грн</p>
                            <Button href="/form" className="btn btn-dark mt-md-4 p-2 rounded-3 fw-bold me-auto mb-5" style={{border:"double 0px white",width:"150px", backgroundColor:"#2a1301"} }>Приєднатися</Button>
                        </div>
                    </div>
                </Carousel.Item>
                <Carousel.Item>
                    <div className="d-block d-md-flex justify-content-center " style={{width:""}}>
                        ...
                        <div className="container-fluid  p-3" style={{width:"", height:"", color:"",marginLeft:"10px"}}>
                            ...
                            <p className=" mt-1 fs-6">Якщо Ви хочете успішно скласти шкільний іспит, вступний іспит до іноземного університету або отримати сертифікат про підтвердження знань мови в майбутньому - попіклуйтеся про якісне та комфортне вивчення мови вже зараз!
                                ...
                                * Заняття проходять індивідуально, в парі або у групах по 4-6 чоловік.<br/>
                                * Кількість занять - 2-3 рази на тиждень.<br/>
                                * Тривалість занять - по 60-80 хв.<br/>
                                * Тривалість курсу - 5-7 місяців.<br/>
                                * Вартість уроку - від 150 грн<br/>
                            </p>
                ...
                <Carousel.Item>
                    <div className="d-block d-md-flex justify-content-center " style={{width:""}}>
                        ...
                        <div className="container-fluid p-3" style={{width:"", height:"", color:"",marginLeft:"10px"}}>
                            ...
                            <p className=" mt-1 fs-6">Індивідуальні заняття для дітей дають змогу максимально пропрацювати найскладніші для кожного учня теми та займатися в зручному та продуктивному темпі. Саме така форма навчання передбачає повне занурення у процес без відволікання, усуває у дитини страх заговорити та соромʼязливість, дозволяє отримувати максимум уваги від викладача, а отже, можливість за менший проміжок часу засвоїти більший обсяг знань.<br/> Крім того, варто також враховувати, що індивідуальні уроки мови — кращий варіант для особливих, специфічних запитів. <br/><br/>
                                * Тривалість заняття 45-60 хв.<br/>
                                * Кількість занять - 2-3 рази на тиждень.<br/>
                                * Вартість одного заняття - від 250 грн.<br/>
                ...
                <Carousel.Item>
                    <div className="d-block d-md-flex justify-content-between " style={{width:""}}>
                        ...
                        <div className="container-fluid p-3 ps-1 pe-5 " style={{width:"", height:"", color:"",marginLeft:"10px"}}>
                            ...
                            <p className="card-text mt-1 fs-6">Ви отримаєте знання структури мови та зрозумієте основні її принципи та правила. Збудуєте міцний та надійний фундамент, на основі якого подальше вивчення мови стане набагато легшим.<br/><br/>
